...
func AddBorderColorStyles(cssClasses map[string]string) {
    borderColorStyles := map[string]string{
		
		"border-black":    "rgb(0 0 0)",
        "border-white":    "rgb(255 255 255)",
        "border-slate-50": "rgb(248 250 252)",
        "border-slate-100": "rgb(241 245 249)",
        "border-slate-200": "rgb(226 232 240)",
        "border-slate-300": "rgb(203 213 225)",
        "border-slate-400": "rgb(148 163 184)",
        "border-slate-500": "rgb(100 116 139)",
        "border-slate-600": "rgb(71 85 105)",
        "border-slate-700": "rgb(51 65 85)",
        "border-slate-800": "rgb(30 41 59)",
		"border-slate-900":    "rgb(15 23 42)",
        "border-slate-950":    "rgb(2 6 23)",
        "border-gray-50":      "rgb(249 250 251)",
        "border-gray-100":     "rgb(243 244 246)",
        "border-gray-200":     "rgb(229 231 235)",
        "border-gray-300":     "rgb(209 213 219)",
        "border-gray-400":     "rgb(156 163 175)",
        "border-gray-500":     "rgb(107 114 128)",
        "border-gray-600":     "rgb(75 85 99)",
        "border-gray-700":     "rgb(55 65 81)",
        "border-gray-800":     "rgb(31 41 55)",
        "border-gray-900":     "rgb(17 24 39)",
        "border-gray-950":     "rgb(3 7 18)",
        "border-zinc-50":      "rgb(250 250 250)",
        "border-zinc-100":     "rgb(244 244 245)",
        "border-zinc-200":     "rgb(228 228 231)",
        "border-zinc-300":     "rgb(212 212 216)",
        "border-zinc-400":     "rgb(161 161 170)",
        "border-zinc-500":     "rgb(113 113 122)",
        "border-zinc-600":     "rgb(82 82 91)",
        "border-zinc-700":     "rgb(63 63 70)",
        "border-zinc-800":     "rgb(39 39 42)",
        "border-zinc-900":     "rgb(24 24 27)",
        "border-zinc-950":     "rgb(9 9 11)",
        "border-neutral-50":   "rgb(250 250 250)",
        "border-neutral-100":  "rgb(245 245 245)",
        "border-neutral-200":  "rgb(229 229 229)",
        "border-neutral-300":  "rgb(212 212 212)",
        "border-neutral-400":  "rgb(163 163 163)",
        "border-neutral-500":  "rgb(115 115 115)",
        "border-neutral-600":  "rgb(82 82 82)",
        "border-neutral-700":  "rgb(64 64 64)",
    "border-neutral-800":  "rgb(38 38 38)",
		"border-neutral-900":  "rgb(23 23 23)",
        "border-neutral-950":  "rgb(10 10 10)",
		...
		"border-red-50": "rgb(254 242 242)",
		"border-red-100": "rgb(254 226 226)",
		"border-red-200": "rgb(254 202 202)",
		"border-red-300": "rgb(252 165 165)",
		"border-red-400": "rgb(248 113 113)",
		"border-red-500": "rgb(239 68 68)",
		"border-red-600": "rgb(220 38 38)",
	"border-red-700": "rgb(185 28 28)",
	"border-red-800": "rgb(153 27 27)",
	"border-red-900": "rgb(127 29 29)",
	"border-red-950": "rgb(69 10 10)",
	"border-orange-50": "rgb(255 247 237)",
    "border-orange-100": "rgb(255 237 213)",
    "border-orange-200": "rgb(254 215 170)",
    "border-orange-300": "rgb(253 186 116)",
    "border-orange-400": "rgb(251 146 60)",
    "border-orange-500": "rgb(249 115 22)",
    "border-orange-600": "rgb(234 88 12)",
    "border-orange-700": "rgb(194 65 12)",
    "border-orange-800": "rgb(154 52 18)",
    "border-orange-900": "rgb(124 45 18)",
    "border-orange-950": "rgb(67 20 7)",
    "border-amber-50": "rgb(255 251 235)",
    "border-amber-100": "rgb(254 243 199)",
    "border-amber-200": "rgb(253 230 138)",
    "border-amber-300": "rgb(252 211 77)",
    "border-amber-400": "rgb(251 191 36)",
    "border-amber-500": "rgb(245 158 11)",
    "border-amber-600": "rgb(217 119 6)",
    "border-amber-700": "rgb(180 83 9)",
    "border-amber-800": "rgb(146 64 14)",
    "border-amber-900": "rgb(120 53 15)",
    "border-amber-950": "rgb(69 26 3)",
	"border-yellow-50": "rgb(254 252 232)",
    "border-yellow-100": "rgb(254 249 195)",
    "border-yellow-200": "rgb(254 240 138)",
    "border-yellow-300": "rgb(253 224 71)",
    "border-yellow-400": "rgb(250 204 21)",
    "border-yellow-500": "rgb(234 179 8)",
    "border-yellow-600": "rgb(202 138 4)",
    "border-yellow-700": "rgb(161 98 7)",
    "border-yellow-800": "rgb(133 77 14)",
    "border-yellow-900": "rgb(113 63 18)",
    "border-yellow-950": "rgb(66 32 6)",
    "border-lime-50": "rgb(247 254 231)",
    "border-lime-100": "rgb(236 252 203)",
    "border-lime-200": "rgb(217 249 157)",
    "border-lime-300": "rgb(190 242 100)",
    "border-lime-400": "rgb(163 230 53)",
    "border-lime-500": "rgb(132 204 22)",
    "border-lime-600": "rgb(101 163 13)",
    "border-lime-700": "rgb(77 124 15)",
    "border-lime-800": "rgb(63 98 18)",
    "border-lime-900": "rgb(54 83 20)",
    "border-lime-950": "rgb(26 46 5)",
	"border-green-50": "rgb(240 253 244)",
    "border-green-100": "rgb(220 252 231)",
    "border-green-200": "rgb(187 247 208)",
    "border-green-300": "rgb(134 239 172)",
    "border-green-400": "rgb(74 222 128)",
    "border-green-500": "rgb(34 197 94)",
    "border-green-600": "rgb(22 163 74)",
    "border-green-700": "rgb(21 128 61)",
    "border-green-800": "rgb(22 101 52)",
    "border-green-900": "rgb(20 83 45)",
    "border-green-950": "rgb(5 46 22)",
    "border-emerald-50": "rgb(236 253 245)",
    "border-emerald-100": "rgb(209 250 229)",
    "border-emerald-200": "rgb(167 243 208)",
    "border-emerald-300": "rgb(110 231 183)",
    "border-emerald-400": "rgb(52 211 153)",
    "border-emerald-500": "rgb(16 185 129)",
    "border-emerald-600": "rgb(5 150 105)",
    "border-emerald-700": "rgb(4 120 87)",
    "border-emerald-800": "rgb(6 95 70)",
    "border-emerald-900": "rgb(6 78 59)",
    "border-emerald-950": "rgb(2 44 34)",
	"border-teal-50": "rgb(240 253 250)",
    "border-teal-100": "rgb(204 251 241)",
    "border-teal-200": "rgb(153 246 228)",
    "border-teal-300": "rgb(94 234 212)",
    "border-teal-400": "rgb(45 212 191)",
    "border-teal-500": "rgb(20 184 166)",
    "border-teal-600": "rgb(13 148 136)",
    "border-teal-700": "rgb(15 118 110)",
    "border-teal-800": "rgb(17 94 89)",
    "border-teal-900": "rgb(19 78 74)",
    "border-teal-950": "rgb(4 47 46)",
    "border-cyan-50": "rgb(236 254 255)",
    "border-cyan-100": "rgb(207 250 254)",
    "border-cyan-200": "rgb(165 243 252)",
    "border-cyan-300": "rgb(103 232 249)",
    "border-cyan-400": "rgb(34 211 238)",
    "border-cyan-500": "rgb(6 182 212)",
    "border-cyan-600": "rgb(8 145 178)",
    "border-cyan-700": "rgb(14 116 144)",
    "border-cyan-800": "rgb(21 94 117)",
    "border-cyan-900": "rgb(22 78 99)",
    "border-cyan-950": "rgb(8 51 68)",
	"border-sky-50": "rgb(240 249 255)",
    "border-sky-100": "rgb(224 242 254)",
    "border-sky-200": "rgb(186 230 253)",
    "border-sky-300": "rgb(125 211 252)",
    "border-sky-400": "rgb(56 189 248)",
    "border-sky-500": "rgb(14 165 233)",
    "border-sky-600": "rgb(2 132 199)",
    "border-sky-700": "rgb(3 105 161)",
    "border-sky-800": "rgb(7 89 133)",
    "border-sky-900": "rgb(12 74 110)",
    "border-sky-950": "rgb(8 47 73)",
    "border-blue-50": "rgb(239 246 255)",
    "border-blue-100": "rgb(219 234 254)",
    "border-blue-200": "rgb(191 219 254)",
    "border-blue-300": "rgb(147 197 253)",
    "border-blue-400": "rgb(96 165 250)",
    "border-blue-500": "rgb(59 130 246)",
    "border-blue-600": "rgb(37 99 235)",
    "border-blue-700": "rgb(29 78 216)",
    "border-blue-800": "rgb(30 64 175)",
    "border-blue-900": "rgb(30 58 138)",
    "border-blue-950": "rgb(23 37 84)",
	"border-indigo-50": "rgb(238 242 255)",
    "border-indigo-100": "rgb(224 231 255)",
    "border-indigo-200": "rgb(199 210 254)",
    "border-indigo-300": "rgb(165 180 252)",
    "border-indigo-400": "rgb(129 140 248)",
    "border-indigo-500": "rgb(99 102 241)",
    "border-indigo-600": "rgb(79 70 229)",
    "border-indigo-700": "rgb(67 56 202)",
    "border-indigo-800": "rgb(55 48 163)",
    "border-indigo-900": "rgb(49 46 129)",
    "border-indigo-950": "rgb(30 27 75)",
    "border-violet-50": "rgb(245 243 255)",
    "border-violet-100": "rgb(237 233 254)",
    "border-violet-200": "rgb(221 214 254)",
    "border-violet-300": "rgb(196 181 253)",
    "border-violet-400": "rgb(167 139 250)",
    "border-violet-500": "rgb(139 92 246)",
    "border-violet-600": "rgb(124 58 237)",
    "border-violet-700": "rgb(109 40 217)",
    "border-violet-800": "rgb(91 33 182)",
    "border-violet-900": "rgb(76 29 149)",
    "border-violet-950": "rgb(46 16 101)",
	"border-purple-50": "rgb(250 245 255)",
    "border-purple-100": "rgb(243 232 255)",
    "border-purple-200": "rgb(233 213 255)",
    "border-purple-300": "rgb(216 180 254)",
    "border-purple-400": "rgb(192 132 252)",
    "border-purple-500": "rgb(168 85 247)",
    "border-purple-600": "rgb(147 51 234)",
    "border-purple-700": "rgb(126 34 206)",
    "border-purple-800": "rgb(107 33 168)",
    "border-purple-900": "rgb(88 28 135)",
    "border-purple-950": "rgb(59 7 100)",
    "border-fuchsia-50": "rgb(253 244 255)",
    "border-fuchsia-100": "rgb(250 232 255)",
    "border-fuchsia-200": "rgb(245 208 254)",
    "border-fuchsia-300": "rgb(240 171 252)",
    "border-fuchsia-400": "rgb(232 121 249)",
    "border-fuchsia-500": "rgb(217 70 239)",
    "border-fuchsia-600": "rgb(192 38 211)",
    "border-fuchsia-700": "rgb(162 28 175)",
    "border-fuchsia-800": "rgb(134 25 143)",
    "border-fuchsia-900": "rgb(112 26 117)",
    "border-fuchsia-950": "rgb(74 4 78)",
	"border-pink-50": "rgb(253 242 248)",
    "border-pink-100": "rgb(252 231 243)",
    "border-pink-200": "rgb(251 207 232)",
    "border-pink-300": "rgb(249 168 212)",
    "border-pink-400": "rgb(244 114 182)",
    "border-pink-500": "rgb(236 72 153)",
    "border-pink-600": "rgb(219 39 119)",
    "border-pink-700": "rgb(190 24 93)",
    "border-pink-800": "rgb(157 23 77)",
    "border-pink-900": "rgb(131 24 67)",
    "border-pink-950": "rgb(80 7 36)",
	// border-rose
    "border-rose-50": "rgb(255 241 242)",
    "border-rose-100": "rgb(255 228 230)",
    "border-rose-200": "rgb(254 205 211)",
    "border-rose-300": "rgb(253 164 175)",
    "border-rose-400": "rgb(251 113 133)",
    "border-rose-500": "rgb(244 63 94)",
    "border-rose-600": "rgb(225 29 72)",
    "border-rose-700": "rgb(190 18 60)",
    "border-rose-800": "rgb(159 18 57)",
    "border-rose-900": "rgb(136 19 55)",
    "border-rose-950": "rgb(76 5 25)",
	// border-x
